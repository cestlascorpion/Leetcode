...
#include "Leetcode306.h"

bool Leetcode306::isAdditiveNumber(string num) {
    int len = num.size();
    if (len < 3)
        return false;
    string num1, num2;
...
string Leetcode306::add(string s1, string s2) {
    string result;
...
bool Leetcode306::DFS(string num, string num1, string num2) {
